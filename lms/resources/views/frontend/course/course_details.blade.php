...
@section('title')
{{ $course->course_name }} | BTS Learning
@endsection
...
<section class="course-details-area pb-20px">
   ...
   <li><i class="la la-check mr-1 text-black"></i>  {{ $goal->goal_name }} </li>
                   ...
                   <div class="course-overview-card bg-gray p-4 rounded">
                       <h3 class="fs-16 font-weight-semi-bold">Curated for the <a href="for-business.html" class="text-color hover-underline">BTSolution for Business</a> collection</h3>
                   </div><!-- end course-overview-card -->
                   <div class="course-overview-card">
                    ...
                    <div class="course-overview-card border border-gray p-4 rounded">
                       <h3 class="fs-20 font-weight-semi-bold">Top companies trust BTSolution</h3>
                       <p class="fs-15 pb-1">Get your team access to BTSolution's top 5,000+ courses</p>
                        <div class="pb-3">
                        ...
                        <a href="for-business.html" class="btn theme-btn theme-btn-sm">Try BTSolution for Business</a>
                   </div><!-- end course-overview-card -->
                   <div class="course-overview-card">
            ...
            <div class="media media-card">
                <div class="instructor-img">
                    <a href="teacher-detail.html" class="media-img d-block">
                        <img class="lazy" src="{{ (!empty($course->user->photo)) ? url('upload/instructor_images/'.$course->user->photo) : url('upload/no_image.jpg')}}" data-src="frontend/images/small-avatar-1.jpg" alt="Avatar image">
                    </a>
   ...
   @endphp
    ...
    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
        <div class="media-img mr-4 rounded-full">
            <img class="rounded-full lazy" src="{{ (!empty($item->user->photo)) ? url('upload/user_images/'.$item->user->photo) : url('upload/no_image.jpg')}}" data-src="frontend/images/small-avatar-1.jpg" alt="User image">
        </div>
        <div class="media-body">
...
<p><b> For Add Course Review. You need to login first <a href="{{ route('login') }}"> Login Here</a> </b> </p>
   ...
   @endphp            
         ...
         <p class="d-flex align-items-center pb-2">
            ...
            <span class="fs-35 font-weight-semi-bold text-black">Rp{{ $course->selling_price }}</span>
            @else
            <span class="fs-35 font-weight-semi-bold text-black">Rp{{ $course->discount_price }}</span>
            <span class="before-price mx-1">Rp{{ $course->selling_price }}</span>
            @endif
            ...
            <ul class="generic-list-item pb-3">
                ...
                <li><i class="la la-certificate mr-2 text-color"></i>Certificate of Completion</li>
                                    ...
                                    <div class="buy-for-team-container pt-4">
                                        ...
                                        <p class="lh-24 pb-3">Get your team access to 3,000+ top BTSolution courses anytime, anywhere.</p>
                                        <a href="for-business.html" class="btn theme-btn theme-btn-sm theme-btn-transparent lh-30 w-100">Try BTSolution for Business</a>
                                    </div>
    ...
    <ul class="generic-list-item generic-list-item-flash">
        ...
        <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
            ...
            <div class="media-body">
                ...
                <p class="text-black font-weight-semi-bold lh-18 fs-15">Rp{{ $related->selling_price }}  </p>
                @else
                <p class="text-black font-weight-semi-bold lh-18 fs-15">Rp{{ $related->discount_price }} <span class="before-price fs-14">Rp{{ $related->selling_price }}</span></p>
                @endif
        ...
        <div class="related-course-wrap">
            ...
            @endphp
                ...
                <div class="card card-item">
                    ...
                    @if ($inscourse->discount_price == NULL)
                    <p class="card-price text-black font-weight-bold">Rp{{ $inscourse->selling_price }}  </p>
                    @else
                    <p class="card-price text-black font-weight-bold">Rp{{ $inscourse->discount_price }} <span class="before-price font-weight-medium">Rp{{ $inscourse->selling_price }}</span></p> 
                    @endif
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-3">
                <div class="cta-btn-box text-right">
                    <a href="become-a-teacher.html" class="btn theme-btn">Tech on BTSolution <i class="la la-arrow-right icon ml-1"></i> </a>
                </div>
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
        ...
        <div class="modal-content">
            <div class="modal-header border-bottom-gray">
                <div class="pr-2">
                    ...
                    <p class="pt-1 fs-14 lh-24">Flagged content is reviewed by BTSolution staff to determine whether it violates Terms of Service or Community Guidelines. If you have a question or technical issue, please contact our
                        ...
                        <div class="form-group">
                            <div class="select-container w-auto">
                                <select class="select-container-select">
                                    ...
                                    <option value="3">BTSolution Policy Violation</option>

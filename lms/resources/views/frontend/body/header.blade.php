...
<div class="col-lg-10">
    <div class="menu-wrapper">
                       ...
                       <br><br>
                        ...
                        <li class="media media-card">
                            <div class="media-body fs-16">
                                <p class="text-black font-weight-semi-bold lh-18">Total: Rp<span class="cart-total" id="cartSubTotal"> </span>  </p>
                            </div>
                        </li>
                        <li>
        ...
        <div class="nav-right-button">
            <a href="{{ route('login') }}" class="btn theme-btn d-none d-lg-inline-block"><i class="la la-user-plus mr-1"></i> Sign In</a>

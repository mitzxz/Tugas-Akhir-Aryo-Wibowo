<header class="header-menu-area">
                                                    ...
                                                    <li>
                                                        <div class="media media-card">
                                                            <a href="course-details.html" class="media-img">
                                                                <img class="mr-3" src="frontend/images/small-img.jpg"
                                                                    alt="Cart image">
                                                            </a>
                                                        ...
                                                        {{-- <ul class="generic-list-item">
                                                            ...
                                                            <li>
                                                                <a href="#" class="position-relative">
                                                                    <span
                                                                        class="fs-17 font-weight-semi-bold d-block">BTSolution
                                                                        for Business</span>
    ...
    <div class="off-canvas-menu custom-scrollbar-styled main-off-canvas-menu">
        ...
        <h4 class="off-canvas-menu-heading pt-20px">More from BTSolution</h4>
        <ul class="generic-list-item off-canvas-menu-list pt-1">
            <li><a href="for-business.html">BTSolution for Business</a></li>

                                        ...
                                        <div class="lecture-overview-item">
                                            <div class="lecture-overview-stats-wrap d-flex">
                                                ...
                                                <div
                                                    ...
                                                    <p class="pb-3">Get BTSolution certificate by completing entire course
                                                    </p>
                                                    <a href="#"
                                                        class="btn theme-btn theme-btn-transparent">BTSolution
                                                        Certificate</a>
                                                </div><!-- end lecture-overview-stats-item -->
                                            </div><!-- end lecture-overview-stats-wrap -->
                                        </div><!-- end lecture-overview-item -->
                                        ...
                                        <div class="lecture-overview-item">
                                            <div class="media media-card align-items-center">
                                                <a href="teacher-detail.html"
                                                    ...
                                                    <img src="frontend/images/small-avatar-1.jpg"
                                            ...
                                            <div class="lecture-announcement-comment-wrap pt-4">
                                                ...
                                                <div class="comments pt-40px">
                                                    ...
                                                    <div
                                                        class="media media-card mb-3 border-bottom border-bottom-gray pb-3">
                                                        <div class="media-img rounded-full avatar-sm flex-shrink-0">
                                                            <img src="frontend/images/small-avatar-3.jpg"
                                                                alt="Instructor avatar" class="rounded-full">
                                                        </div><!-- end media-img -->
                                                        <div class="media-body">
                                                            <div class="announcement-meta fs-15 lh-20">
                                ...
                                <div class="col-lg-6">
                                    <div class="cta-content-wrap">
                                        <h3 class="fs-18 font-weight-semi-bold">Top companies choose <a
                                                href="for-business.html" class="text-color hover-underline">BTSolution for
                    ...
                    <div class="footer-area pt-50px">
                        ...
                        <div class="copyright-content py-4">
                            <div class="container-fluid">
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <p class="copy-desc">&copy; 2024 BTSolution. All Rights Reserved. by <a
                                                href="https://x.com/ashxxt1y.com/">Aryo Wibowo</a></p>
                                    </div><!-- end col-lg-6 -->
                                    <div class="col-lg-6">
            ...
            <div class="modal-content">
                <div class="modal-header border-bottom-gray">
                    <div class="pr-2">
                        ...
                        <p class="pt-1 fs-14 lh-24">Flagged content is reviewed by BTSolution staff to determine whether it

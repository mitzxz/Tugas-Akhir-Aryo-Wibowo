        ...
        <div class="row feature-content-wrap">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">Our teachers are industry professionals with years of experience and a passion for educating the next generation. They bring real-world insights to the classroom, ensuring you gain practical and applicable knowledge.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">We prioritize open and effective communication. Whether it's through email, chat, or in-person meetings, we're here to support you every step of the way.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">Upon completion of our courses, you’ll receive a certificate that’s recognized by industry leaders, opening doors to new opportunities and career growth.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->

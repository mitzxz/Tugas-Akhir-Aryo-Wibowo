...
<div class="card card-item">
        ...
        <div class="payment-option-wrap">
            <div class="payment-tab is-active">
                <div class="payment-tab-toggle">
                    <input id="directPayment" name="cash_delivery" type="radio" value="handcash">
                ...
                <div class="payment-tab-toggle">
                    <input id="midtransPayment" name="cash_delivery" type="radio" value="midtrans">
                    <label for="midtransPayment">Midtrans Payment</label>
                </div>
    ...
    @endforeach     
           ...
           @endif            
                        ...
                        <div class="btn-box border-top border-top-gray pt-3">
                            <p class="fs-14 lh-22 mb-2">BTSolution is required by law to collect applicable transaction taxes for purchases made in certain tax jurisdictions.</p>
                            ...
                            <button id="pay-button" type="submit" class="btn theme-btn w-100">Proceed <i class="la la-arrow-right icon ml-1"></i></button>
    ...
    {{-- <script type="text/javascript">
        document.getElementById('pay-button').addEventListener('click', function (event) {
            ...
            var selectedPayment = document.querySelector('input[name="cash_delivery"]:checked').value;
 
            if (selectedPayment === 'midtrans') {
                var snapToken = '{{ session('snap') }}'; // Ambil token dari session
                window.location.href = snapToken; // Arahkan ke URL yang diberikan oleh Midtrans
            } else {
                this.form.submit(); // Jika bukan Midtrans, kirim form
            }
        });
    </script> --}}
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <div class="payment-option-wrap">
                            <div class="payment-tab is-active">
                                <div class="payment-tab-toggle">
                                    <input id="directPayment" name="payment_method" type="radio" value="handcash">
                                    <label for="directPayment">Direct Payment</label>
                                </div>
                                <div class="payment-tab-toggle">
                                    <input id="stripePayment" name="payment_method" type="radio" value="stripe">
                                    <label for="stripePayment">Stripe Payment</label>
                                </div>
                                <div class="payment-tab-toggle">
                                    <input id="midtransPayment" name="payment_method" type="radio" value="midtrans">
                                    <label for="midtransPayment">Midtrans Payment</label>
                                </div>
                            </div><!-- end payment-tab -->
                        </div>
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <div class="btn-box border-top border-top-gray pt-3">
                            <p class="fs-14 lh-22 mb-2">BTSolution is required by law to collect applicable transaction taxes for purchases made in certain tax jurisdictions.</p>
                            <p class="fs-14 lh-22 mb-3">By completing your purchase you agree to these <a href="#" class="text-color hover-underline">Terms of Service.</a></p>
                            <button type="button" class="btn theme-btn w-100" id="pay-button">Proceed <i class="la la-arrow-right icon ml-1"></i></button>
                        </div>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-5 -->

                ...
                <div class="instructor-wrap py-5">
                    ...
                    <div class="media media-card">
                        <div class="media-img rounded-full avatar-lg mr-4">
                            <img src="frontend/images/img-loading.png" data-src="frontend/images/small-avatar-1.jpg" alt="Avatar image" class="rounded-full lazy">
                        </div>
                    ...
                    <div class="comment-list">
                        <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                            <div class="media-img mr-4 rounded-full">
                                <img class="rounded-full lazy" src="frontend/images/img-loading.png" data-src="frontend/images/small-avatar-1.jpg" alt="User image">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4 review-reply">
                            <div class="media-img mr-4 rounded-full">
                                <img class="rounded-full lazy" src="frontend/images/img-loading.png" data-src="frontend/images/small-avatar-2.jpg" alt="User image">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                            <div class="media-img mr-4 rounded-full">
                                <img class="rounded-full lazy" src="frontend/images/img-loading.png" data-src="frontend/images/small-avatar-3.jpg" alt="User image">
                            </div>
                            <div class="media-body">
